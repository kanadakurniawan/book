...
tags: ["curah hujan", "BMKG", "prediksi hujan", "CSI", "FAR", "POD", "LSTM", "SHAP", "walk-forward", "studi kasus"]
version: "1.0.0"
...
![Gambar 9.1 — Precision-recall curve untuk deteksi hujan lebat (ilustratif)](figures/fig-9-1-precision-recall.png)
...
![Gambar 9.2 — Verifikasi per kategori intensitas (ilustratif)](figures/fig-9-2-verifikasi-kategori.png)
