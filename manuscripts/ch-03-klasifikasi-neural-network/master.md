...
![Gambar 3.1 — Kurva sigmoid memetakan nilai z (−∞ sampai +∞) ke rentang (0, 1)](figures/fig-3-1-sigmoid.png)
...
![Gambar 3.2 — Confusion matrix contoh data tidak seimbang (2 benar, 8 miss, 20 false alarm, 970 benar-tidak)](figures/fig-3-2-confusion-matrix.png)
