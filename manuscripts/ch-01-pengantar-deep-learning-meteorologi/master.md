...
*Machine learning* (pembelajaran mesin) adalah cabang AI yang membuat komputer belajar
pola dari data tanpa diprogram secara eksplisit untuk setiap aturan [2]. Alih-alih menulis
...
biologis [3]. "Dalam" (deep) merujuk pada banyaknya lapisan; setiap lapisan mengekstrak
representasi yang semakin abstrak dari data [3].
...
Deep learning bukan teknologi baru dalam konsep (perceptron pertama lahir 1958 [4]),
...
bukan hanya peneliti ilmu komputer [6].
...
Buku ini menggunakan **Google Colab** (gratis) dengan **TensorFlow/Keras** [5]. Colab
...
6. M. Reichstein et al., "Deep learning and process understanding for data-driven Earth
